...
{
    public partial class PlaceB : Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                if (Session["PLACE_TYPE"].ToString() != "B" && Session["LEVEL"].ToString() != "3")
                {
        ...
        private void BindGrid()
        {
            ...
            sql += " WHERE place_type='B' AND show_=1 AND job_date ='" + today + "' ORDER by job_id desc";
            DataTable dt;
