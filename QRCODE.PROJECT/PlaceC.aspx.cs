...
{
    public partial class PlaceC : Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                if (Session["PLACE_TYPE"].ToString() != "C" && Session["LEVEL"].ToString() != "3")
                {
        ...
        private void BindGrid()
        {
            ...
            sql += " WHERE place_type='C' AND show_=1 AND job_date ='" + today + "' ORDER by job_id desc";
            DataTable dt;
